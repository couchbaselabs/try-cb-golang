# Couchbase Go travel-sample Application REST Backend
...
(You can also view a read-only version at https://docs.couchbase.com/go-sdk/current/hello-world/sample-application.html#)
 ...
 * Start the backend server locally, for example using "Running the Go API application manually" above.
